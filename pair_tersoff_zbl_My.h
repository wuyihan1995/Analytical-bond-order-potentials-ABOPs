...
PairStyle(tersoff/zbl/my,PairTersoffZBLMy)

#else

#ifndef LMP_PAIR_TERSOFF_ZBL_MY_H
#define LMP_PAIR_TERSOFF_ZBL_MY_H

#include "pair_tersoff_My.h"

namespace LAMMPS_NS {

class PairTersoffZBLMy : public PairTersoffMy {
 public:
  PairTersoffZBLMy(class LAMMPS *);
  ~PairTersoffZBLMy() {}
